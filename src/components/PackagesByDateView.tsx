        ...
        <CardHeader>
            ...
            <div className="text-sm text-gray-600">
              ...
              {dispatches.length > 0 && (
                <span className="ml-2 text-blue-600">
                  • {dispatches.length} despacho{dispatches.length !== 1 ? 's' : ''} creado{dispatches.length !== 1 ? 's' : ''}
                </span>
              )}
            </div>
            {totalPackages > 0 && (
          ...
          {totalPackages > 0 && (
            <div className="grid grid-cols-4 gap-4 mt-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-purple-600">{grandTotals.weight} kg</div>
                <div className="text-xs text-gray-600">Peso Total</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-orange-600">${grandTotals.freight}</div>
                <div className="text-xs text-gray-600">Flete Total</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">${grandTotals.amount_to_collect}</div>
