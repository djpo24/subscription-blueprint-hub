...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-black text-white hover:bg-gray-900 rounded-full shadow-none border-0",
        destructive:
          "bg-red-500 text-white hover:bg-red-600 rounded-full shadow-none border-0",
        outline:
          "border border-gray-300 bg-white hover:bg-gray-50 hover:text-gray-900 rounded-full shadow-none",
        secondary:
          "bg-gray-100 text-black hover:bg-gray-200 rounded-full shadow-none border-0",
