...
-- Buscar el número +5990000000010 en todas las tablas que contengan números de teléfono

-- 1. Buscar en la tabla customers
SELECT 'customers' as tabla, id, name, phone, whatsapp_number, email
FROM public.customers 
WHERE phone LIKE '%5990000000010%' 
   OR whatsapp_number LIKE '%5990000000010%';
...
WHERE from_phone LIKE '%5990000000010%';
...
WHERE recipient_phone LIKE '%5990000000010%';
